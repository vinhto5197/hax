...
-- the app must NOT connect as it or RLS is decorative in dev. `hax` stays the
-- owner: Alembic migrations run as it (DDL needs ownership).
-- Mirrors prod: RDS gives no superuser; app role ≠ master role there too.
DO $$ BEGIN
